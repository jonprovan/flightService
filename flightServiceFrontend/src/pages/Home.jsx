    ...
    return (
        <div className="container">
            ...
            <div className='homeContent'>
                ...
                <hr></hr>
                <p>Here at Ted Striker's Flight Service, we pride ourselves on reasonably low BACs and an unwavering commitment to simply climbing into the cockpit and seeing what the heck happens.</p>
                ...
                <p>We thank you for choosing Ted Striker's Flight Service, and may you rest in peace.</p>
            </div>
